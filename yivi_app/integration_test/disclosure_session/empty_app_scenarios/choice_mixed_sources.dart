...
Future<void> choiceMixedSourcesTest(
  WidgetTester tester,
  ...
  expect(
    find.byType(DisclosurePermissionObtainCredentialsScreen),
    findsOneWidget,
  );
  ...
  expect(
    (templateCardsFinder.evaluate().first.widget as YiviCredentialCard).style,
    IrmaCardStyle.highlighted,
  );
  expect(
    (templateCardsFinder.evaluate().elementAt(1).widget as YiviCredentialCard)
        .style,
