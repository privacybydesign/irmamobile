...
void main() {
  ...
  // ! This test should run in full isolation. Don't add it to a test group.
  // ! The ScannerScreen is used in this test so the camera permission pop up will appear,
  // ! and the test will continue to run behind it.
  // ! We don't want this pop up to overlap other tests as well.
