...
import "../../screens/enrollment/accept_terms/accept_terms_screen.dart";
import "../../screens/enrollment/accept_terms/widgets/error_reporting_check_box.dart";
import "../../screens/enrollment/choose_pin/choose_pin_screen.dart";
import "../../screens/enrollment/confirm_pin/confirm_pin_screen.dart";
import "../../screens/enrollment/enrollment_screen.dart";
import "../../screens/enrollment/widgets/enrollment_instruction.dart";
...
void main() {
  ...
  group("enrollment", () {
    ...
    testWidgets("terms", (tester) async {
      ...
      final defaultReportErrorsValue = await irmaBinding.repository.preferences
          .getReportErrors()
          .first;
      ...
      final defaultErrorReportingCheckBoxValue = tester
          .widget<Checkbox>(errorReportingCheckBoxFinder)
          .value;
      ...
      final updatedReportErrorsValue = await irmaBinding.repository.preferences
          .getReportErrors()
          .first;
      expect(updatedReportErrorsValue, true);

      final updatedErrorReportingCheckBoxValue = tester
          .widget<Checkbox>(errorReportingCheckBoxFinder)
          .value;
      ...
      final errorReportingTextWidget = tester.widget<Text>(
        errorReportingTextFinder,
      );

      // The second text span in the rich text should be the link
      final linkTextSpan =
          (errorReportingTextWidget.textSpan as TextSpan).children?.elementAt(1)
              as TextSpan;
      ...
      final actualErrorReportingBottomSheetText = tester.getAllText(
        bottomSheetFinder,
      );
      expect(
        actualErrorReportingBottomSheetText,
        expectedErrorReportingBottomSheetText,
      );
      ...
      expect(
        tester.widget<YiviThemedButton>(nextButtonFinder).onPressed,
        isNull,
      );

      // Accept the terms checkbox
      final termsCheckBoxFinder = find.byKey(
        const Key("accept_terms_checkbox"),
      );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final bottomBarPrimaryButtonFinder = find.byKey(
          const Key("bottom_bar_primary"),
        );
        expect(
          tester
              .widget<YiviThemedButton>(bottomBarPrimaryButtonFinder)
              .onPressed,
          isNull,
        );
        ...
        await tester.enterText(emailInputFinder, "yivitest+$seed@gmail.com");
