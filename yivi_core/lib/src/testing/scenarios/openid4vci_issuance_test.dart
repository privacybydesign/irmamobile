...
import "../../screens/activity/widgets/activity_card.dart";
import "../../screens/activity/widgets/activity_detail_issuance.dart";
import "../../screens/activity/widgets/activity_detail_removal.dart";
import "../../screens/data/data_tab.dart";
import "../../screens/data/schemaless_credentials_details_screen.dart";
import "../../screens/error/error_screen.dart";
import "../../screens/error/tx_code_lockout_screen.dart";
import "../../screens/session/widgets/issuance_permission.dart";
import "../../screens/session/widgets/issuance_success_screen.dart";
import "../../screens/session/widgets/openid4vci_preauth_txcode_screen.dart";
...
const _emailCredentialTileKey = "https://veramo-issuer.openid4vc.staging.yivi.app/test-issuer/vct/email";
...
void main() {
  ...
  group("openid4vci-issuance", () {
    ...
    testWidgets("issue-email-openid4vci", (tester) => testIssueEmailOpenID4VCI(tester, irmaBinding));
    ...
    testWidgets("issue-organization-openid4vci", (tester) => testIssueOrganizationOpenID4VCI(tester, irmaBinding));
    ...
    testWidgets("wrong-tx-code-shows-inline-error", (tester) => testWrongTxCodeShowsInlineError(tester, irmaBinding));

    testWidgets("wrong-then-correct-tx-code", (tester) => testWrongThenCorrectTxCode(tester, irmaBinding));
    ...
    testWidgets("cancel-after-wrong-tx-code-attempt", (tester) => testCancelAfterWrongAttempt(tester, irmaBinding));
...
Future<void> testIssueEmailOpenID4VCI(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
...
Future<void> testIssueEmailOpenID4VCIWithTxCode(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
  ...
  await tester.enterText(find.byKey(const Key("openid4vci_tx_code_input_field")), offer.txCode!);
...
Future<void> testIssueOrganizationOpenID4VCI(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
...
Future<void> testDismissOnIssuancePermissionScreen(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
...
Future<void> testWrongTxCodeShowsInlineError(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
  ...
  await tester.pumpUntilFound(find.byType(OpenID4VCIPreAuthTxCodeScreen));
  await tester.enterText(find.byKey(const Key("openid4vci_tx_code_input_field")), "000000");
  await tester.pumpUntilFound(find.text("Incorrect code. 2 attempts remaining."));
...
Future<void> testWrongThenCorrectTxCode(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
...
Future<void> testTwoWrongAttemptsThenCorrect(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
  ...
  await tester.enterText(find.byKey(const Key("openid4vci_tx_code_input_field")), "111111");
  await tester.pumpUntilFound(find.text("Incorrect code. 1 attempt remaining."));
...
/// error screen.
Future<void> testThreeWrongAttemptsLockout(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
  ...
  await tester.enterText(find.byKey(const Key("openid4vci_tx_code_input_field")), "111111");
  await tester.pumpUntilFound(find.text("Incorrect code. 1 attempt remaining."));
  await tester.enterText(find.byKey(const Key("openid4vci_tx_code_input_field")), "222222");
...
Future<void> testCancelAfterWrongAttempt(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
...
Future<void> testCancelTxCodeScreenDismissesSession(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
...
Future<void> testRemoveDedupedAndUniqueCredentials(WidgetTester tester, IntegrationTestIrmaBinding irmaBinding) async {
  await pumpAndUnlockApp(tester, irmaBinding.repository);
  ...
  await _issueEmailCredViaPreAuth(tester, irmaBinding, email: "test@example.com");
  await _issueEmailCredViaPreAuth(tester, irmaBinding, email: "test@example.com");
  await _issueEmailCredViaPreAuth(tester, irmaBinding, email: "other@example.com");
  ...
  final mergedCard = find.ancestor(of: find.text("test@example.com"), matching: find.byType(YiviCredentialCard));
  expect(mergedCard, findsOneWidget);
  await tester.tapAndSettle(find.descendant(of: mergedCard, matching: find.byIcon(Icons.more_horiz_sharp)));
  ...
  await tester.tapAndSettle(find.byType(ActivityCard, skipOffstage: false).at(1));
  expect(find.byType(ActivityDetailsScreen), findsOneWidget);
  expect(find.byType(ActivityDetailRemoval), findsOneWidget);
  expect(find.byType(YiviCredentialCard), findsOneWidget);
  await evaluateCredentialCard(
