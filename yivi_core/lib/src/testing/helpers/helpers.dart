...
import "../../providers/rooted_device_detector_provider.dart";
import "../../screens/add_data/schemaless_add_data_details_screen.dart";
...
import "../../widgets/credential_card/yivi_credential_card_footer.dart";
...
OcrProcessor? _testOcrProcessor;

/// Configures the OCR implementation used by shared integration tests.
void configureTestOcrProcessor(OcrProcessor processor) {
  _testOcrProcessor = processor;
}
  ...
  await tester.pumpWidgetAndSettle(
    ProviderScope(
      overrides: [
        ...
        if (_testOcrProcessor != null)
          ocrProcessorProvider.overrideWithValue(_testOcrProcessor!),
