...
class _YiviPinScreenState extends State<YiviPinScreen>
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(
                  top: context.yivi.spacing.screenPadding,
                ),
  ...
  Widget _buildTopColumn(
    ...
    return Column(
      ...
      spacing: context.yivi.spacing.base.scaleToDesignSize(context),
      children: [
        if (!hideLogo) ...[
      ...
      child: Column(
        ...
        children: [
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: context.yivi.pin.counter(_state.pin.isNotEmpty),
                    ),
                  ),
                ),
            ],
          ...
          if (isLong)
            FractionallySizedBox(
              widthFactor: fieldWidthFactor,
              child: Divider(height: 1.0, color: context.colors.secondary),
            ),
        ],
      ),
    );
