...
// abcba, abcab
// n = 5
bool _pinMustNotContainPatternAbcba(List<int> pin) =>
    !(pin[0] == pin[4] && pin[1] == pin[3] && pin[0] != pin[1]);
bool _pinMustNotContainPatternAbcab(List<int> pin) =>
    !(pin[0] == pin[3] && pin[1] == pin[4] && pin[0] != pin[1]);
