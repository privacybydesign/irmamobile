          ...
          .mapIndexed(
            (candidateIndex, candidateEntry) =>
                ...
                ? Column(
                    ...
                    children: [
                      ...
                      DisclosurePermissionChoice(
                        ...
                        choice: {
                          for (int i = 0; i < candidateEntry.value.length; i++)
                            i: candidateEntry.value[i],
                        },
                        selectedConIndex:
                            selectedConIndices[candidateEntry.key]!,
                ...
                : DisclosureIssueWizardCredentialCards(
                    ...
                    credentials: candidateEntry
                        .value[selectedConIndices[candidateEntry.key]!],
                  ),
          )
          .toList(),
    );
