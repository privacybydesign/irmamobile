...
CredentialStatusNotification _$CredentialStatusNotificationFromJson(
  Map<String, dynamic> json,
) =>
    CredentialStatusNotification(
        credentialHash: json["credentialHash"] as String,
        type: $enumDecode(
          _$CredentialStatusNotificationTypeEnumMap,
          json["type"],
        ),
      ...
      ..content = NotificationTranslatedContent.fromJson(
...
Map<String, dynamic> _$CredentialStatusNotificationToJson(
  CredentialStatusNotification instance,
) => <String, dynamic>{
  "id": instance.id,
