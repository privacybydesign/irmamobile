        ...
        child: Padding(
          ...
          child: ListView(
            children: <Widget>[
              ...
              _buildFontExample(context, "p (Body 1)", IrmaTheme.of(context).textTheme.bodyText2),
              _buildFontExample(context, "p-bold (Body 2)", IrmaTheme.of(context).textTheme.bodyText1),
              ...
              _buildFontExample(context, "Subhead", IrmaTheme.of(context).textTheme.subtitle1),
              _buildFontExample(context, "Subtitle", IrmaTheme.of(context).textTheme.subtitle2),
