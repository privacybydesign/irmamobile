...
class SecurityContextBinding {
  ...
  static void ensureInitialized() {
    ...
    if (Platform.isAndroid) {
      for (final cert in _pinnedCerts) {
        final encodedCert = ascii.encode(cert);
        SecurityContext.defaultContext.setTrustedCertificatesBytes(encodedCert);
      }
    }
    _initialized = true;
  }

  static const _pinnedCerts = [
