...
final List<IrmaCardTheme> backgrounds = [
  IrmaCardTheme(const Color(0xff6CE6C1), const Color(0xff3BB992), const Color(0xff15222E)),
  IrmaCardTheme(const Color(0xff43C3E0), const Color(0xff00B1E5), const Color(0xff15222E)),
  IrmaCardTheme(const Color(0xffFFE8CD), const Color(0xffFFB54C), const Color(0xff15222E)),
