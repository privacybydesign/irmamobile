...
class YiviCompactCredentialCard extends StatelessWidget {
  ...
  const YiviCompactCredentialCard({
    super.key,
    required this.type,
  ...
  static YiviCompactCredentialCard fromCredentialLog(IrmaConfiguration irmaConfiguration, CredentialLog credential) {
    ...
    return YiviCompactCredentialCard(
  ...
  YiviCompactCredentialCard.fromMultiFormatCredential(
  ...
  YiviCompactCredentialCard.fromCredential(
      ...
      child: Column(
        ...
        children: [
          GreyedOut(
            ...
            child: YiviCompactCredentialCardHeader(
