...
AuthenticateEvent _$AuthenticateEventFromJson(Map<String, dynamic> json) =>
    AuthenticateEvent(pin: json['Pin'] as String, schemeId: json['SchemeID'] as String);
...
AuthenticationErrorEvent _$AuthenticationErrorEventFromJson(Map<String, dynamic> json) =>
    AuthenticationErrorEvent(error: SessionError.fromJson(json['Error'] as Map<String, dynamic>));
