...
LogsEvent _$LogsEventFromJson(Map<String, dynamic> json) => LogsEvent(
      logEntries:
          (json['LogEntries'] as List<dynamic>).map((e) => LogEntry.fromJson(e as Map<String, dynamic>)).toList(),
    );
...
SignedMessage _$SignedMessageFromJson(Map<String, dynamic> json) => SignedMessage(
