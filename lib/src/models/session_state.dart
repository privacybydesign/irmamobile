...
class SessionState {
  ...
  SessionState({
    ...
    required this.launchedCredentials,
  ...
  bool get didIssueLaunchedCredential =>
      issuedCredentials?.any(
        (cred) => launchedCredentials.contains(cred.info.fullId),
      ) ??
      false;
  ...
  SessionState copyWith({
    ...
    return SessionState(
      ...
      launchedCredentials: launchedCredentials,
