...
class RespondPreAuthorizedCodeFlowPermissionEvent extends SessionEvent {
  ...
  factory RespondPreAuthorizedCodeFlowPermissionEvent.fromJson(Map<String, dynamic> json) =>
      _$RespondPreAuthorizedCodeFlowPermissionEventFromJson(json);
  Map<String, dynamic> toJson() => _$RespondPreAuthorizedCodeFlowPermissionEventToJson(this);
}
...
class RespondAuthorizationCodeAndExchangeForTokenEvent extends SessionEvent {
  ...
  factory RespondAuthorizationCodeAndExchangeForTokenEvent.fromJson(Map<String, dynamic> json) =>
      _$RespondAuthorizationCodeAndExchangeForTokenEventFromJson(json);
  Map<String, dynamic> toJson() => _$RespondAuthorizationCodeAndExchangeForTokenEventToJson(this);
}
...
class RequestPermissionAndPerformAuthCodeWithTokenExchangeSessionEvent extends SessionEvent {
  ...
  factory RequestPermissionAndPerformAuthCodeWithTokenExchangeSessionEvent.fromJson(Map<String, dynamic> json) =>
      _$RequestPermissionAndPerformAuthCodeWithTokenExchangeSessionEventFromJson(json);
}
...
class RequestPreAuthorizedCodeFlowPermissionSessionEvent extends SessionEvent {
  RequestPreAuthorizedCodeFlowPermissionSessionEvent(
      {required int sessionID, required this.serverName, this.credentialInfoList})
      : super(sessionID);
  ...
  factory RequestPreAuthorizedCodeFlowPermissionSessionEvent.fromJson(Map<String, dynamic> json) =>
...
class TokenRequestForPreAuthorizedCodeParameters {
  ...
  factory TokenRequestForPreAuthorizedCodeParameters.fromJson(Map<String, dynamic> json) =>
